...
import type {
	update8_docs,
} from '@satisfactory-dev/docs.json.ts/generated-types/0.8.3.3/types.ts';
...
> => {
	...
	const FGConsumableDescriptor: update8_imports[
		'FGConsumableDescriptor'
	] = find<
		FGConsumableDescriptor,
		'FGConsumableDescriptor'
	...
	const FGEquipmentDescriptor: update8_imports[
		'FGEquipmentDescriptor'
	] = find<
		FGEquipmentDescriptor,
		'FGEquipmentDescriptor'
	...
	const FGSchematic: update8_imports['FGSchematic'] = find<
		FGSchematic,
		'FGSchematic'
	>('FGSchematic', update8);
